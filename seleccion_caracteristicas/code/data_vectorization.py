...
# Usar con dataset de Drebin. Acumula las veces que aparece cada tipo de atributo.
...
# Usar con cualquier otro dataset excepto el de Drebin. Acumula las veces que aparece cada tipo de atributo.
apk_total_feature_name = \
    {
...
def count_feature_set(feature_file):
    ...
    for linea in feature_file:
        if linea != "\n":
            ...
            # Acumula las veces que va apareciendo cada tipo de atributo
            # Ejemplo:
            # apk_total_feature_name = {"componente_actividades":5,...,"uses_feature":42}
...
def read_sha_files():
    ...
    for filename in os.listdir(dir_of_files):
        ...
        # nombre del apk que será usado para mostrar el nombre del apk y no de su respectivo archivo .txt.
        ...
        apks_array_csv.append([apk_name] + count_feature_set(sha_data))
        ...
        print("id" + " " + str(count) + " " + "nombre_apk" + " " + apk_name + " " + "feature vector" + " " +
    ...
    print("----------------------------------------------------")
    print("***** Representación % del tipo en el dataset *****")
    print("----------------------------------------------------")
    for feature, feature_count in apk_total_feature_name.items():
...
print("----------------------------------------------------------------------------------")
print("***** Contenido dataframe con aplicaciones del dataset (benignas + malware) *****")
print("----------------------------------------------------------------------------------")
print(apk_column)
...
print("--------------------------------------------------------------------------")
print("***** Contenido de dataframe con etiquetas asignadas a aplicaciones *****")
print("--------------------------------------------------------------------------")
print(malware)
...
print("---------------------------------------------------------------------------------------")
print("***** Contenido de archivo de salida  feature_vectors_counts a usar en el modelo *****")
print("---------------------------------------------------------------------------------------")
print(feature_vectors_data)
print("---------------------------------------------------------------------------------------")
